...
a66.admin.interfaz = {
    init: function() {
        ...
        var panelBienvenida = new Ext.Panel({
            ...
            collapsible: true,
            html: '<div style="background: url(images/3.jpg) no-repeat center;widht:200px;height:100%;margin:1px auto;text-align:center;color:#277AD0;"><img id="loguito" src="images/logo_conta3161.png" /></div>'
        });
